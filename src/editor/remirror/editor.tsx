...
import { FloatingWrapper, Remirror, ThemeProvider, useRemirror, useRemirrorContext } from '@remirror/react'
...
function FloatingButtons() {
  ...
  return (
    <FloatingWrapper positioner="cursor" placement="top">
      ...
      <button onClick={() => commands.toggleItalic()} style={{ fontWeight: active.italic?.() ? 'bold' : undefined }}>
        Italic
      </button>
      <button
